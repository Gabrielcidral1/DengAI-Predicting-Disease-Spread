...
rf_reg <- tuneRF(x = sj_tr[ , head(unique(x$names),i)], y = sj_tr$total_cases, ntreeTry=100,stepFactor=2,improve=0.05,trace=F, doBest = T) 
...
sj <- sj[11:936 , 3:25] # to exclude NAs
