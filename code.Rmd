...
preprocessparams <- preProcess(x = select(sj[ , which(sapply(sj,is.numeric))], -total_cases) ,method = c("center","scale","pca","BoxCox"))
...
rf_final_df <- rbind(iq_te[ , c("city", "type", "total_cases","weekofyear", "week_start_date", "year")], sj_te[ , c("city", "type", "total_cases","weekofyear", "week_start_date", "year")])
