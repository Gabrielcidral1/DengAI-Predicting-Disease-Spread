...
rf_reg <- tuneRF(x = sj_tr[ , head(unique(x$names),15)], y = sj_tr$total_cases, ntreeTry=100,stepFactor=2,improve=0.05,trace=F, doBest = T) 
...
rf_reg <- tuneRF(sj[ , head(unique(x$names),15)], sj$total_cases, ntreeTry=100,stepFactor=2,improve=0.05,trace=TRUE, plot=T) 
